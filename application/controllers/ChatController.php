...
public function index(){
   ...
   public function send_text_message(){
        ...
        $get_project_id = $this->ChatModel->get_project_id($this->OuthModel->Encryptor('decrypt', $post['receiver_id'])); 
...
$status_dispute = $this->ChatModel->updateHighlight($this->OuthModel->Encryptor('decrypt', $post['receiver_id']),$send_id);
