...
<div class="form-group row">
                           ...
                           <div class="form-group row">
                                ...
                                <br>
                                <div class="col-md-9">
                                    <input type="text"  id="mission_status" name="mission_status" value="<?php if($withdrawpayment_edit[0]->mission_status == 0) { echo "Proposed";} else if($withdrawpayment_edit[0]->mission_status == 1) { echo "In Progress";}  else if($withdrawpayment_edit[0]->mission_status == 2) { echo "Delivered";}  else if($withdrawpayment_edit[0]->mission_status == 3) { echo "Completed";}  else if($withdrawpayment_edit[0]->mission_status == 4) { echo "Dispute";} ?>" readonly>
                                </div>
                            </div>
                             ...
                             <div class="form-group row">
                                ...
                                <br>
                                <div class="col-md-9">
                                    <input type="text"  id="amount_to_pay" name="amount_to_pay" value="<?php echo $withdrawpayment_edit[0]->amount_to_pay;?>" >
                                </div>
                            </div>
                            <?php
