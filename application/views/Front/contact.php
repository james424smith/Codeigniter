                   ...
                   <?php } ?>
                    <div class="content-frm">
                          ...
                          <form class="contact2-form validate-form" action="<?php echo base_url('Front/Posts/saveContact'); ?>" method="post">
                              ...
                              <div class="wrap-input2 validate-input">
                                 <input placeholder="Entrez votre numéro de téléphone" class="mc-field-group" type="number" name="contact_no" pattern="[1-9]{1}[0-9]{9}" minlength="10"  maxlength="10" id="" value="<?php echo set_value('contact_no'); ?>" required>          
                                </div>
