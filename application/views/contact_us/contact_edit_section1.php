                                               ...
                                               <div class="table-responsive">
                                                  <div class="form-validation">
                                                     <form class="form-valide" action="<?php echo base_url('ContactContent/save_contact')?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                                        ...
                                                        <input type="hidden" class="form-control" id="mobile_number" name="mobile_number" value="<?php echo $edit_section1[0]['number']?>">
                                                        <input type="hidden" class="form-control" id="email" name="email" value="<?php echo $edit_section1[0]['email']?>">

                                                        <div class="form-group row">
                                                           <label class="col-md-3 col-form-label" for="val-username">Name <span class="text-danger">*</span>
                                                           </label>
                                                           <div class="col-md-9">
                                                              <input type="text" class="form-control" value="<?php echo $edit_section1[0]['title']?>" disabled>
                                                              <input type="hidden" class="form-control" id="title" name="title" value="<?php echo $edit_section1[0]['title']?>">
                                                           </div> 
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                           ...
                                                           <div class="col-md-9">
                                                              <textarea class="form-control" disabled><?php echo $edit_section1[0]['description']?></textarea>
                                                              <input type="hidden" class="form-control" name="description" value="<?php echo $edit_section1[0]['description']?>">
                                                           </div>
                                                        </div>
                                                        <div class="form-group row">
