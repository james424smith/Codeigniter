...
$data = $this->db->get()->result();
echo $data[0]->offer_budget; ?></td><!-- <td><?php echo $user->offer_budget; ?></td> -->
...
<td>
                  ...
                  <a href='<?php echo base_url("demandsList/delete_demands/$user->mission_id");?>' onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i></a></td>
