<?php
class Walletwithdrawask_model extends CI_Model
{
  ...
  public function __construct() 
  {
    ...
    $this->walletwithdrawask = 'walletwithdrawask';
  }
...
public function getUserList($from_date,$to_date) 
  {
    $this->db->select("id,date_of_ask,wallet_amount,user_email,comment");
    //$this->db->from($this->userTbl);
$this->db->where('date_updated >=', $from_date);
$this->db->where('date_updated <=', $to_date);
    $q = $this->db->get('walletwithdrawask');
...
//delete user list by id
  ...
  public function WalletwithdrawaskList() {
    $query = $this->db->get($this->walletwithdrawask);
    return $query->result();
  }
  ...
  {
    $this->db-> where('id', $id);
    return $this->db->delete($this->walletwithdrawask);
  }
